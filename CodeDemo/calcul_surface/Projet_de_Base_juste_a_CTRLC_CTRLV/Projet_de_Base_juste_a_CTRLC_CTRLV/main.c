...
int main(void)
{
    ...
    float longueur_base_m = 0;
    float longueur_hauteur_m = 0;
    float longueur_rayon_m = 0;

    //creation des variables pour les surfaces

    float surface_carre_m2 = 0;
    float surface_rectangle_m2 = 0;
    float surface_triangle_m2 = 0;
    float surface_cercle_m2 = 0;
